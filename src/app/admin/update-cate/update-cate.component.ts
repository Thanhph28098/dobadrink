...
export class UpdateCateComponent implements OnInit {
   ...
   constructor(
      ...
      this.route.params.subscribe((params) => {
         ...
         this.http.get(`https://angular-service.onrender.com/api/categories/${params['id']}`).subscribe((response: any) => {
   ...
   updateCate() {
      ...
      this.http
         .patch('https://angular-service.onrender.com/api/categories/' + this.cateId, cate, {
            headers: {
