...
export class DetailProductComponent implements OnInit {
   ...
   ngOnInit(): void {
      this.route.paramMap.subscribe((params) => {
         ...
         let apiUrl = 'https://angular-service.onrender.com/api/products/' + this.id
   ...
   fv: any
   getFavorite() {
      let apiGet = 'https://angular-service.onrender.com/api/favorites/' + this.idP
   ...
   comment: any
   getCMT() {
      let apiUrlCMT = 'https://angular-service.onrender.com/api/comment/' + this.id
   ...
   heart: any
   checkHeart() {
      let api = 'https://angular-service.onrender.com/api/favorites/'
   ...
   getData() {
      let apiUrl = 'https://angular-service.onrender.com/api/products'
   ...
   addComment() {
      if (this.formData.idUser) {
         let apiUrl = 'https://angular-service.onrender.com/api/comment'
   ...
   addFavorite() {
      if (this.idLocal) {
         let apiUrl = 'https://angular-service.onrender.com/api/favorites'
         this.http.get(apiUrl).subscribe((res: any) => {
            ...
            if (checkP) {
               let removeFv =
                  'https://angular-service.onrender.com/api/favorites/' + this.favoriteData.idUser + '/' + this.favoriteData.idProduct
   ...
   removeComment(id: string) {
      let api = 'https://angular-service.onrender.com/api/comment/' + this.id
